...
SERVICE_SCHEMA = vol.Schema({
    ...
    vol.Optional("setting_font_path", default="/config/custom_components/advanced_snapshot/Arial.ttf"): cv.string,
...
async def async_setup(hass: HomeAssistant, config: ConfigType) -> bool:
    async def handle_take_snapshot(call: ServiceCall) -> ServiceResponse:
        ...
        setting_font_path = call.data.get("setting_font_path", "/config/custom_components/advanced_snapshot/Arial.ttf")
